CREATE DATABASE  IF NOT EXISTS `Viki_Eats` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `Viki_Eats`;
...
INSERT INTO `food_items` VALUES (1,'Pav Bhaji',6.00),(2,'Chole Bhature',7.00),(3,'Pizza',8.00),(4,'Mango Lassi',5.00),(5,'Masala Dosa',6.00),(6,'Vegetable Biryani',9.00),(7,'Vada Pav',4.00),(9,'Samosa',5.00);
...
INSERT INTO `orders` VALUES (1,1,2,12.00),(1,3,1,8.00),(2,4,3,15.00),(2,6,2,18.00),(2,9,4,20.00);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'Viki_Eats'
--
